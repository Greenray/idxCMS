...
<fieldset>
    <form name="topics" method="post" action="">
        <table class="std">
            ...
            <tr>
                <th class="title">[__Title]</th><th class="author">[__Date]</th><th class="author">[__Author]</th>
                [if=items[file]]<th>[__File]</th><th>[__Size]</th><th>[__Downloads]</th>[/if]
                [if=items[song]]<th>[__File]</th><th>[__Size]</th><th>[__Downloads]</th>[/if]
                [if=items[site]]<th>[__Site URL]</th><th>[__Transitions]</th>[/if]
                <th>[__Views]</th><th>[__Comments]</th><th class="actions">[__Actions]</th>
            </tr>
            [each=items]
            <tr class="odd">
                ...
                [if=items[file]]<td>{items[file]}</td><td class="right">{items[size]}</td><td class="center">{items[downloads]}</td>[/if]
                [if=items[song]]<td>{items[song]}</td><td class="right">{items[size]}</td><td class="center">{items[downloads]}</td>[/if]
                [if=items[site]]<td class="left">{items[site]}</td><td class="center">{items[clicks]}</td>[/if]
