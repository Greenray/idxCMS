...
REDIPS.drag = (function () {
	...
	var	init,						// initialization
		...
		style = {borderEnabled : 'solid',	// (string) border style for enabled elements
				...
				rowEmptyColor : '#FFFFFF'},	// (string) color of empty row
		...
		clone = {keyDiv : true,		    // (boolean) if true, elements could be cloned with pressed SHIFT key
				keyRow : true,			// (boolean) if true, rows could be cloned with pressed SHIFT key
				sendBack : true,		// (boolean) if true, then cloned element can be returned to its source
