...
<fieldset>
    <form name="navigation" method="post" action="">
        <div id="drag">
            <table id="sortable">
                <tr><th></th><th>[__Link]</th><th>[__Title] / [__Description]</th><th class="title">[__Icon]</th></tr>
                [each=links]
                <tr>
                    ...
                    <td style="width:17%;">
                        <select name="icons[]">
                            [each=links[icons]]
                            <option value="{icons[id]}" [if=icons[selected]]selected="selected"[/if]>{icons[id]}</option>
                            [/each.links[icons]]
                        </select>
                    </td>
                </tr>
