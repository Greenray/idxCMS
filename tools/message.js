...
function inlineMsg(b, d) {
    ...
    if (!document.getElementById("err")) {
        ...
        msgcontent = document.getElementById("errmsg");
    }
    msgcontent.innerHTML = d;
    msg.style.display = "block";
    var g = msg.offsetHeight;
    var j = document.getElementById(b);
    j.focus();
    var h = j.offsetHeight;
    var k = j.offsetWidth;
    var a = topPosition(j);
    var l = leftPosition(j) + f;
    msg.style.top = a + "px";
    msg.style.left = l + "px";
    clearInterval(msg.timer);
    msg.timer = setInterval("fadeMsg(1)", timer);
    window.setTimeout("hideMsg()", (i * 1000));
}
function hideMsg(a) {
    var a = document.getElementById("err");
    if (!a.timer) {
        a.timer = setInterval("fadeMsg(0)", timer);
    }
}
function fadeMsg(a) {
    var c = 5;
...
(function () {
    ...
    var t = dhtmlx.message = function (text) {
