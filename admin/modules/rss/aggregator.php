...
if (!empty($REQUEST['save_s'])) {
    $config = [];
    $config['cache_time']   = empty($REQUEST['cache_time'])   ? 3600 : (int) $REQUEST['cache_time'];
    $config['title_length'] = empty($REQUEST['title_length']) ? 30   : (int) $REQUEST['title_length'];
    $config['desc_length']  = empty($REQUEST['desc_length'])  ? 50   : (int) $REQUEST['desc_length'];
