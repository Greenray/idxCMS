...
(function (factory) {
    if (typeof define === 'function' && define.amd) define(['jquery'], factory);  // AMD. Register as an anonymous module
    else if (typeof exports === 'object') module.exports = factory; // Node/CommonJS style for Browserify
