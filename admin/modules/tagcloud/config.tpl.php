    ...
    <form name="config" method="post" action="">
        <table class="std">
            ...
            <tr class="light">
                ...
                <td>__In an ideal: 3/4 from width__</td>
            </tr>
            <tr class="light">
                <td>__Background__</td>
                <td>$bgcolor</td>
                <td>__Background at the switched off transparency__</td>
            </tr>
            <tr class="light">
                <td>__Tags color__</td>
                <td>$color</td>
                <td>__Leave a field empty for a multi-color mode__</td>
            </tr>
            <tr class="light">
...
<fieldset>
    <form name="tc_edit" method="post" action="">
        <table class="std">
            ...
            <!-- FOREACH tag = $used -->
                <tr class="light">
                    <td class="center"><input type="text" name="key[]" value="$tag._CUR_" /></td>
                    <td class="center"><input type="hidden" name="value[]" value="$tag._VAL_" />$tag._VAL_</td>
                    <td class="center"> + </td>
                </tr>
            <!-- ENDFOREACH -->
            <!-- FOREACH unused = $unused -->
                <tr class="light">
                    <td class="center"><input type="text" name="key[]" value="$unused._CUR_" /></td>
                    <td class="center"><input type="hidden" name="value[]" value="$unused._VAL_" />$unused._VAL_</td>
                    <td class="center"> - </td>
                </tr>
            <!-- ENDFOREACH -->
        </table>
