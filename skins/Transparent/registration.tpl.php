...
<script type="text/javascript">
    $(function () {
        ...
        $('#registration>fieldset').each(function() {
            $(this).children(':last').find(':input').keydown(function(e) {
                if (e.which === 9) {
...
<a href="#" class="overlay" id="register"></a>
        ...
        <div id="steps">
            <form name="registration" id="registration" method="post" action="" enctype="multipart/form-data" onsubmit="return checkUserForm(this);">
                ...
                <fieldset class="step">
                    ...
                    $captcha
                    <p class="msg help">__Required fields have a yellow background__</p>
                    <p class="navigation"><input type="submit" name="save" value="__Save__" /></p>
                </fieldset>
            </form>
        </div>
        <div class="navigation">
            <ul>
                <li class="selected"><a href="#">__Account__</a></li>
                <li><a href="#">__Additionally__</a></li>
                <li><a href="#">__Communication__</a></li>
                <li><a href="#">__Avatar__</a></li>
                <li><a href="#">__Save__</a></li>
            </ul>
        </div>
    </div>
</div>
