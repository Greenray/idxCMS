...
<fieldset>
    <form name="item" method="post" action="" enctype="multipart/form-data" onsubmit="return checkImage(this);">
        <table class="std">
            ...
            <tr class="odd">
                <td>[__Upload]</td>
                <td colspan="3"><input type="file" name="image" value="" size="80" class="text" /></td>
            </tr>
            <tr class="odd">
                <td>[__Title]</td>
            ...
            <tr class="odd">
                <td>[__Comments]</td>
                <td colspan="3"><input type="checkbox" name="opened" value="1" [if=opened]checked="checked"[endif] /><label for="opened"> [__Allow]</label></td>
            </tr>
        </table>
        <p class="center">
