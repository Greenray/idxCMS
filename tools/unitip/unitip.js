...
var unitipize = function (element) {
	var a = element;
...
var move = function (evt) {
	...
	if (TipHeight >= WinHeight) {
		...
		if (document.getElementById('uniTipP')) {
			tippointin.style.left = (TipWidth >= WinWidth ) ? "-" + elewidth + "px" : "0";
		...
		if (document.getElementById('uniTipP')) {
			tippointin.style.left = (TipWidth >= WinWidth ) ? "-" + elewidth + "px" : "0";
			tippointin.style.top  = "0";
		} else tippoint.style.backgroundPosition = (TipWidth >= WinWidth ) ? "right top" : "left top";

		if (document.getElementById('uniTipC')) tipcapin.style.top = "0";
