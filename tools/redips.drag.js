...
REDIPS.drag = function () {
    ...
    q = function (a) {
        ...
        for (b = a = 0; a < e.length; a++)
            if (!("redips_clone" === e[a].parentNode.id || -1 < e[a].className.indexOf("nolayout"))) {
                c = e[a].parentNode;
                d = 0;
                do
        ...
        a = 0;
        for (e = Z = 1; a < f.length; a++)
            if (0 === f[a].redips.nestedLevel) {
                f[a].redips.nestedGroup = e;
                f[a].redips.sort = 100 * Z;
                c = f[a].getElementsByTagName("table");
                for (b = 0; b < c.length; b++)
                    -1 < c[b].className.indexOf("nolayout") || (c[b].redips.nestedGroup = e, c[b].redips.sort = 100 * Z + c[b].redips.nestedLevel);
                e++;
                Z++;
            }
    };
    za = function (a) {
        ...
        if (null === j || null === h || null === k)
            if (Q(), z = t = j, I = v = h, T = A = k, null === j || null === h || null === k);
                return!0;
        va = p = !1;
    ...
    Ma = function (a) {
        ...
        for (a = 0; a < f.length; a++)
            f[a].redips.nestedGroup === b && (f[a].redips.sort = 100 * Z + f[a].redips.nestedLevel);
        f.sort(function (a, b) {
    ...
    fa = function (a, b) {
        var c, d, e, g, f, w;
        if ("DIV" === a.nodeName)
            return g = a, a = x("TR", a), void 0 === a.redips && (a.redips = {}), a.redips.div = g, a;
        d = a;
        ...
        for (f = e; 0 <= f; f--)
            if (f !== d.rowIndex) {
                if (!0 === g && void 0 === b) {
                    e = c.rows[f];
                    for (w = 0; w < e.cells.length; w++)
                        if (-1 < e.cells[w].className.indexOf("rowhandler")) {
                            g = !1;
                            break
                        }
                }
        ...
        for (c = 0; c < g.length; c++)
            for (d = 0; d < g[c].length; d++)
                switch (e = g[c][d].type, e) {
                    ...
                    for (e = 0; e < g[c][d].options.length; e++)
                        f[c][d].options[e].selected = g[c][d].options[e].selected;
                    }
    };
    ba = function (a) {
        ...
        R = S = 0;
        if (p && "cell" === r && (null === j || null === h || null === k))
            i.parentNode.removeChild(i), H[m.id] -= 1, REDIPS.drag.event.notCloned();
        else if (null === j || null === h || null === k)
            ...
            if ("row" === r)
                if (va)
                    if (z === c && I === d) {
                        ...
                        for (a = 0; a < b.cells.length; a++)
                            m.cells[a].style.backgroundColor = b.cells[a].style.backgroundColor;
                ...
                REDIPS.drag.event.notMoved();
            else if (p && z === j && I === h && T === k)
                i.parentNode.removeChild(i), H[m.id] -= 1, REDIPS.drag.event.notCloned();
            else if (p && !1 === REDIPS.drag.clone.drop && (a < b.redips.offset[3] || a > b.redips.offset[1] || e < b.redips.offset[0] || e > b.redips.offset[2]))
                i.parentNode.removeChild(i), H[m.id] -= 1, REDIPS.drag.event.notCloned();
            else if (-1 < l.target.className.indexOf(REDIPS.drag.trash.className))
                i.parentNode.removeChild(i),
                ...
                if (a = REDIPS.drag.event.droppedBefore(l.target), !1 === a)
                    ha(!1);
                else {
                    i.parentNode.removeChild(i);
                    ...
                    c = b.length;
                    for (a = 0; a < c; a++)
                        void 0 !== b[0] && (REDIPS.drag.objOld = m = b[0], l.source.appendChild(m), U(m));
                    ha();
        ...
        if (!1 !== a) {
            if (!0 === Ua.sendBack) {
                ...
                for (c = 0; c < a.length; c++)
                    if (i !== a[c] && 0 === i.id.indexOf(a[c].id)) {
                        b = a[c];
                        break
                    }
                if (b) {
            ...
            p && i.parentNode && i.parentNode.removeChild(i);
    };
    U = function (a, b) {
    ...
    ca = function (a) {
        ...
        g = Math.abs(Sa - e);
        if (!va) {
            if ("cell" === r && ($ || !0 === REDIPS.drag.clone.keyDiv && Ja))
                REDIPS.drag.objOld = m = i, REDIPS.drag.obj = i = ma(i, !0), p = !0, REDIPS.drag.event.cloned();
            else {
                if ("row" === r) {
                    if ($ || !0 === REDIPS.drag.clone.keyRow && Ja)
                        p = !0;
        ...
        va = !0;
        if ("cell" === r && (7 < c || 7 < g) && !ga)
            ga = !0, ja(), REDIPS.drag.event.moved(p);
        d > o[3] && d < F - o[1] && (i.style.left = d - o[3] + "px");
        e > o[0] && e < G - o[2] && (i.style.top = e - o[0] + "px");
        if (d < D[1] && d > D[3] && e < D[2] && e > D[0] && 0 === R && 0 === S && (n.containTable || d < n[3] || d > n[1] || e < n[0] || e > n[2]))
            Q(), ia();
        if (REDIPS.drag.scroll.enable) {
            M = b - (F / 2 > d ? d - o[3] : F - d - o[1]);
            if (0 < M) {
                if (M > b && (M = b), c = K()[0], M *= d < F / 2 ? -1 : 1, !(0 > M && 0 >= c || 0 < M && c >= ta - F) && 0 === R++);
                    REDIPS.event.remove(window, "scroll",
                            u), ka(window);
            } else
                M = 0;
            N = b - (G / 2 > e ? e - o[0] : G - e - o[2]);
            if (0 < N) {
                if (N > b && (N = b), c = K()[1], N *= e < G / 2 ? -1 : 1, !(0 > N && 0 >= c || 0 < N && c >= ua - G) && 0 === S++);
                    REDIPS.event.remove(window, "scroll", u), la(window);
            } else
                N = 0;
            for (g = 0; g < L.length; g++)
                if (c = L[g], c.autoscroll && d < c.offset[1] && d > c.offset[3] && e < c.offset[2] && e > c.offset[0]) {
    ...
    ia = function () {
        if (j < f.length && (j !== t || h !== v || k !== A))
            null !== t && (null !== v && null !== A) && (X(t, v, A, Y), REDIPS.drag.td.previous = l.previous = f[t].rows[v].cells[A], REDIPS.drag.td.current = l.current = f[j].rows[h].cells[k], "switching" === REDIPS.drag.dropMode && "cell" === r && (da(l.current, l.previous), u(), Q()), "cell" === r ? REDIPS.drag.event.changed(l.current) :
    ...
    Q = function () {
        ...
        for (j = 0; j < f.length; j++)
            if (!1 !== f[j].redips.enabled && (c[0] = f[j].redips.offset[0], c[1] = f[j].redips.offset[1], c[2] = f[j].redips.offset[2], c[3] = f[j].redips.offset[3], void 0 !== f[j].sca && (c[0] = c[0] > f[j].sca.offset[0] ? c[0] : f[j].sca.offset[0], c[1] = c[1] < f[j].sca.offset[1] ? c[1] : f[j].sca.offset[1], c[2] = c[2] < f[j].sca.offset[2] ? c[2] : f[j].sca.offset[2], c[3] = c[3] > f[j].sca.offset[3] ?
                ...
                do
                    for (k = e = f[j].rows[h].cells.length - 1; 0 <= k && !(n[3] = c[h][3] + f[j].rows[h].cells[k].offsetLeft, n[1] = n[3] + f[j].rows[h].cells[k].offsetWidth, n[3] <= b && b <= n[1]); k--)
                        ;
                while (f[j].redips.rowspan &&
                        - 1 === k && 0 < h--);
                ...
                if (-1 === b.className.indexOf(REDIPS.drag.trash.className))
                    if (g = -1 < b.className.indexOf(REDIPS.drag.only.cname) ? !0 : !1, !0 === g) {
                ...
                if ("cell" === r) {
                    if (("single" === REDIPS.drag.dropMode || g) && 0 < b.childNodes.length) {
                        if (1 === b.childNodes.length && 3 === b.firstChild.nodeType)
                            break;
                        g = !0;
                        for (d = b.childNodes.length - 1; 0 <= d; d--)
                            if (b.childNodes[d].className && -1 < b.childNodes[d].className.indexOf("drag")) {
                                g = !1;
                                break
                            }
    ...
    X = function (a, b, c, d) {
        if ("cell" === r && ga)
            c = f[a].rows[b].cells[c].style, c.backgroundColor = void 0 === d ? REDIPS.drag.hover.colorTd : d.color[0].toString(), void 0 !== REDIPS.drag.hover.borderTd && (void 0 === d ? c.border = REDIPS.drag.hover.borderTd : (c.borderTopWidth = d.top[0][0],
            ...
            for (b = 0; b < a.cells.length; b++)
                c = a.cells[b].style, c.backgroundColor = void 0 === d ? REDIPS.drag.hover.colorTr : d.color[b].toString(),
    ...
    Da = function (a, b, c) {
        ...
        if ("cell" === r)
            c = f[a].rows[b].cells[c], d.color[0] = c.style.backgroundColor, void 0 !== REDIPS.drag.hover.borderTd && (d.top[0] = e(c, "Top"), d.right[0] = e(c, "Right"), d.bottom[0] = e(c, "Bottom"), d.left[0] = e(c, "Left"));
        else {
            a = f[a].rows[b];
            for (b = 0; b < a.cells.length; b++)
                c = a.cells[b], d.color[b] = c.style.backgroundColor, void 0 !== REDIPS.drag.hover.borderTr && (d.top[b] = e(c, "Top"), d.bottom[b] = e(c, "Bottom"));
        }
        return d;
    };
    C = function (a, b, c) {
        ...
        if (void 0 === c || !0 === c) {
            do
                d += a.offsetLeft - a.scrollLeft, e += a.offsetTop - a.scrollTop, a = a.offsetParent;
            while (a && "BODY" !== a.nodeName)
        } else {
            do
                d += a.offsetLeft, e += a.offsetTop, a = a.offsetParent;
            while (a && "BODY" !== a.nodeName)
        }
    ...
    u = function () {
        ...
        for (a = 0; a < f.length; a++) {
            ...
            for (b = f[a].rows.length -
                    1; 0 <= b; b--)
                "none" !== f[a].rows[b].style.display && (c[b] = C(f[a].rows[b], d));
            f[a].redips.offset = C(f[a], d);
            f[a].redips.row_offset = c;
        }
        D = C(y);
        for (a = 0; a < L.length; a++)
            d = E(L[a].div, "position"), b = C(L[a].div, d, !1), L[a].offset = b, L[a].midstX = (b[1] + b[3]) / 2, L[a].midstY = (b[0] + b[2]) / 2;
    };
    K = function () {
        var a, b;
    ...
    B = function (a, b) {
        ...
        for (d = c = 0; c < g.length; c++)
            if (l.test(g[c].className))
                "init" === a || void 0 === g[c].redips ? (g[c].redips = {}, g[c].redips.container = y) : !0 === a && "number" === typeof i ? (g[c].style.opacity =
                        "", g[c].style.filter = "") : !1 === a && "number" === typeof i && (g[c].style.opacity = i / 100, g[c].style.filter = "alpha(opacity=" + i + ")"), U(g[c], j), g[c].style.borderStyle = w, g[c].style.cursor = h, g[c].redips.enabled = j;
            else if ("init" === a && (e = E(g[c], "overflow"), "visible" !== e)) {
    ...
    x = function (a, b, c) {
        b = b.parentNode;
        for (void 0 === c && (c = 0); b && b.nodeName !== a; )
            if ((b = b.parentNode) && b.nodeName === a && 0 < c);
                c--, b = b.parentNode;
        return b;
    };
    Ga = function (a, b) {
        ...
        if (a !== b && !("object" !== typeof a || "object" !== typeof b))
            if (g = a.childNodes.length, "animation" === c) {
                if (0 < g) {
                    ...
                    for (c = 0; c < g; c++)
                        1 === a.childNodes[c].nodeType && "DIV" === a.childNodes[c].nodeName && (wa[e]++, d(a.childNodes[c], b));
                }
            } else
                for (d = c = 0; c < g; c++)
                    1 === a.childNodes[d].nodeType && "DIV" === a.childNodes[d].nodeName ? (e = a.childNodes[d], REDIPS.drag.event.relocateBefore(e, b), b.appendChild(e), e.redips && !1 !== e.redips.enabled &&
    ...
    ea = function (a, b) {
        ...
        if ("TD" === a.nodeName) {
            ...
            if ("test" === b)
                return c = l.source === a ? void 0 : 0 === a.childNodes.length || 1 === a.childNodes.length && 3 === a.firstChild.nodeType ? !0 : !1;
            for (e = 0; e < c; e++)
                d.push(a.childNodes[0]), a.removeChild(a.childNodes[0]);
            return d;
        }
    };
    oa = function (a, b) {
        ...
        if (a !== b) {
            ...
            for (c[0] !== e[0] && c[1] !== e[1] && (p = !0); c[0] !== g[0] || c[1] !== g[1]; )
                (h = i[c[0] + "-" + c[1]], c[m] += f, 0 > c[m] ? (c[m] = d, c[o]--) : c[m] > d && (c[m] = 0, c[o]++), e = i[c[0] + "-" + c[1]], void 0 !== e && (j = e), void 0 !== h && (k = h), void 0 !== e && void 0 !== k || void 0 !== j && void 0 !== h) ? (e = -1 === j.className.indexOf(REDIPS.drag.mark.cname) ?
    ...
    Na = function (a) {
        ...
        for (h = 0; h < i.length; h++)
            for (j = 0; j < i[h].cells.length; j++) {
                ...
                g = c.colSpan || 1;
                b[a] = b[a] || [];
                for (k = 0; k < b[a].length + 1; k++)
                    if ("undefined" === typeof b[a][k]) {
                        f = k;
                        break
                    }
                d[a +
    ...
    Oa = function (a) {
        ...
        for (d = 0; d < b.length; d++) {
            for (e = a = 0; e < b[d].cells.length; e++)
                a += b[d].cells[e].colSpan || 1;
            a > c && (c = a);
        }
        return c;
    };
    ...
    qa = function (a) {
        ...
        b = c =
                d = -1;
        if (void 0 === a)
            b = j < f.length ? f[j].redips.idx : null === t || null === v || null === A ? f[z].redips.idx : f[t].redips.idx, c = f[z].redips.idx, b = [b, h, k, c, I, T];
        else {
            if (a = "string" === typeof a ? document.getElementById(a) : a)
                "TD" !== a.nodeName && (a = x("TD", a)), a && "TD" === a.nodeName && (b = a.cellIndex, c = a.parentNode.rowIndex, a = x("TABLE", a), d = a.redips.idx);
            b = [d, c, b];
        }
        return b;
    };
    ...
    ra = function (a, b, c) {
        ...
        if ("TR" === a.nodeName) {
            ...
            for (d = 0; d < a.length; d++)
                if (a[d].style.backgroundColor = c ? c : "", "empty" === b)
                    a[d].innerHTML = "";
                else
                    for (e = 0; e < a[d].childNodes.length; e++)
                        1 === a[d].childNodes[e].nodeType && (a[d].childNodes[e].style.opacity = b / 100, a[d].childNodes[e].style.filter = "alpha(opacity=" +
                                b + ")");
        } else
            a.style.opacity = b / 100, a.style.filter = "alpha(opacity=" + b + ")", a.style.backgroundColor = c ? c : ""
    };
    return{obj: i, objOld: m, mode: r, td: l, hover: {colorTd: "#E7AB83", colorTr: "#E7AB83"}, scroll: {enable: !0, bound: 25, speed: 20}, only: ya, mark: Ta, style: {borderEnabled: "solid", borderDisabled: "dotted", opacityDisabled: "", rowEmptyColor: "white"}, trash: {className: "trash", question: null, questionRow: null}, saveParamName: "p", dropMode: "multiple", multipleDrop: "bottom", clone: Ua, animation: {pause: 20, step: 2, shift: !1}, shift: {mode: "horizontal1",
            ...
            for (a = 0; a < b.length; a++)
                REDIPS.event.add(b[a], "mousemove", J), REDIPS.event.add(b[a], "touchmove", J);
            REDIPS.event.add(window, "scroll", u);
        }, initTables: q, enableDrag: B, enableTable: function (a, b) {
            var c;
            if ("object" === typeof b && "TABLE" === b.nodeName)
                b.redips.enabled = a;
            else
                for (c = 0; c < f.length; c++)
                    -1 < f[c].className.indexOf(b) && (f[c].redips.enabled = a);
            ...
            if (void 0 !== a && "object" === typeof a && "TABLE" === a.nodeName) {
                ...
                for (i = 0; i < d; i++) {
                    ...
                    for (j = 0; j < e; j++)
                        if (f = a.rows[i].cells[j], 0 < f.childNodes.length)
                            for (k = 0; k < f.childNodes.length; k++)
                                h = f.childNodes[k], "DIV" === h.nodeName && -1 < h.className.indexOf("drag") && (c += m + "[]=" + h.id + "_" + i + "_" + j + "&", l.push([h.id, i, j]));
                }
            ...
            "string" === typeof a.id ? b.obj = b.objOld = document.getElementById(a.id) : "object" ===
                    typeof a.obj && "DIV" === a.obj.nodeName && (b.obj = b.objOld = a.obj);
            if ("row" === a.mode) {
                b.mode = "row";
                h = pa(a.source[0]);
                i = a.source[1];
                m = b.objOld = f[h].rows[i];
                if (m.redips && !0 === m.redips.emptyRow)
                    return!1;
            ...
            if (!("object" !== typeof b.obj || null === b.obj))
                return b.obj.style.zIndex = 999, b.obj.redips && y !==
